        ...
        <div className='max-w-[1240] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='flex flex-col w-full p-4 my-4 duration-300 rounded-lg shadow-xl hover:scale-105'>
                ...
                <div className='font-medium text-center'>
                    ...
                    <p className='py-2 mx-8 border-b'>Send up to 32 GB</p>
                </div>
                <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-[#000000] '>Start Trail</button>
            </div>
